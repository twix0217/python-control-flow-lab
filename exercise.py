...
def check_letter():
    letters = input("Please enter a letter between a and z: ")
    lower = letters.lower()
    ...
    if lower in vowels:
        ...
        print(f"{letters} is not a vowel.")
...
def check_voting_eligibility():
    ...
    if ages < 0:
        ...
        if ages >= voting_age:
            ...
            print("You are not eliguible to vote.")
...
def determine_season():
    ...
    def is_date_in_range(month, day, start_month, start_day, end_month, end_day):
        if month == start_month and day >= start_day:
            return True
        if month == end_month and day <= end_day:
            return True
        if (start_month < month < end_month) or (start_month < month < end_month) or \
    ...
    for season, (start, end) in seasons.items():
        ...
        if is_date_in_range(month, day, start_month, start_day, end_month, end_day):
